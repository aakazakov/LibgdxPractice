...
public class Building extends GameObject implements Poolable  {
  ...
  public void setup(BaseLogic ownerLogic, int cellX, int cellY) {
    ...
    this.position.set(cellX * BattleMap.CELL_SIZE + BattleMap.CELL_SIZE / 2,
        cellY * BattleMap.CELL_SIZE + BattleMap.CELL_SIZE / 2);
    this.cellX = cellX;
    this.cellY = cellY;
    this.hpMax = 1000;
    this.hp = this.hpMax;
  ...
  public void render(SpriteBatch batch) {
    ...
    batch.draw(texture, textureWorldPosition.x, textureWorldPosition.y, BattleMap.CELL_SIZE * 3,
        BattleMap.CELL_SIZE * 2);
    batch.setColor(0.5f, 0.2f, 0.2f, 0.8f);
    batch.draw(texture, textureWorldPosition.x + BattleMap.CELL_SIZE, textureWorldPosition.y - BattleMap.CELL_SIZE,
        BattleMap.CELL_SIZE, BattleMap.CELL_SIZE);
