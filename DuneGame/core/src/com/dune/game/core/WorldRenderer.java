...
public class WorldRenderer {
  ...
  public WorldRenderer(SpriteBatch batch, GameController gc) {
    ...
    this.frameBuffer = new FrameBuffer(Format.RGB888, ScreenManager.WORLD_WIDTH, ScreenManager.WORLD_HEIGHT,
        false);
  ...
  public void render() {
    ...
    shaderProgram.setUniformf(shaderProgram.getUniformLocation("px"),
        gc.getPointOfView().x / ScreenManager.WORLD_WIDTH);
    shaderProgram.setUniformf(shaderProgram.getUniformLocation("py"),
        gc.getPointOfView().y / ScreenManager.WORLD_HEIGHT);
    Gdx.gl.glClearColor(0, 0, 0, 1);
    Gdx.gl.glClear(GL20.GL_COLOR_BUFFER_BIT);
